...
class Plant(models.Model):
    ...
    pfaf_botanical_references = models.CharField(max_length=60, blank=True, null=True)
    pfaf_family = models.CharField(max_length=60, blank=True, null=True)
    pfaf_common_name = models.CharField(max_length=80, blank=True, null=True)
    pfaf_habit = models.CharField(max_length=40, blank=True, null=True)
    pfaf_deciduous_evergreen = models.CharField(max_length=4, blank=True, null=True)
    pfaf_width = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
    pfaf_hardyness = models.IntegerField(blank=True, null=True)
    pfaf_in_cultivation = models.IntegerField(blank=True, null=True)
    pfaf_medicinal = models.TextField(blank=True, null=True)
    pfaf_range = models.TextField(blank=True, null=True)
    pfaf_habitat = models.TextField(blank=True, null=True)
    pfaf_soil = models.CharField(max_length=10, blank=True, null=True)
    pfaf_shade = models.CharField(max_length=10, blank=True, null=True)
    pfaf_moisture = models.CharField(max_length=10, blank=True, null=True)
    pfaf_well_drained = models.IntegerField(blank=True, null=True)
    pfaf_nitrogen_fixer = models.IntegerField(blank=True, null=True)
    pfaf_ph = models.CharField(max_length=10, blank=True, null=True)
    pfaf_acid = models.IntegerField(blank=True, null=True)
    ...
    pfaf_wildlife = models.IntegerField(blank=True, null=True)
    ...
    pfaf_cultivation_details = models.TextField(blank=True, null=True)
    pfaf_edible_uses = models.TextField(blank=True, null=True)
    pfaf_uses_notes = models.TextField(blank=True, null=True)
    pfaf_propagation_1 = models.TextField(blank=True, null=True)
    pfaf_cultivars = models.IntegerField(blank=True, null=True)
    pfaf_cultivars_in_cultivation = models.IntegerField(blank=True, null=True)
    pfaf_heavy_clay = models.IntegerField(blank=True, null=True)
    pfaf_pull_out = models.IntegerField(blank=True, null=True)
    pfaf_last_update = models.CharField(max_length=40, blank=True, null=True)
    pfaf_record_checked = models.IntegerField(blank=True, null=True)
    pfaf_edibility_rating = models.IntegerField(blank=True, null=True)
    pfaf_frost_tender = models.CharField(max_length=4, blank=True, null=True)
    pfaf_site_specificNotes = models.TextField(blank=True, null=True)
    pfaf_scented = models.IntegerField(blank=True, null=True)
    pfaf_medicinal_rating = models.IntegerField(blank=True, null=True)
